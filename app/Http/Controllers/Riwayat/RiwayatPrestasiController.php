...
class RiwayatPrestasiController extends Controller
{
    ...
    public function index()
    {
        ...
        $riwayat = RiwayatPrestasi::with('Pegawai')->where('id_pegawai',Auth::user()->id_pegawai )->get();
        // return $riwayat;
        // $hubungan = MasterHubungan::get();

        return view('user-views.pages.riwayat.prestasi',compact('riwayat'));
    }
