...
class RiwayatSanskiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $riwayat = RiwayatPelanggaran::with('Pelanggaran.Sanksi')->where('id_pegawai',Auth::user()->id_pegawai )->get();
        // return $riwayat;
        // $hubungan = MasterHubungan::get();

        return view('user-views.pages.riwayat.sanksi',compact('riwayat'));
    }
