...
<main class="page-content">
    <div class="container-fluid">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Mutasi Pangkat</div>
            <div class="ps-3">
                                ...
                                <table id="example" class="table table-striped table-bordered dataTable"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 80px;">Pangkat Sekarang</th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Proses SK Mutasi Pangkat {{ $item->jenis_mutasi }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('mutasi-pangkat.update', $item->id_usulan) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <label class="small mt-3">Detail Mutasi Pangkat</label>
                    <hr>
                    </hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <label class="small mb-1 mr-1">Pangkat Asal</label>
                            <input class="form-control"  type="text" value="{{ $item->Pegawai->Pangkat->nama_pangkat }}, {{ $item->Pegawai->Pangkat->golongan }}" readonly></input>
                        </div>
                        <div class="col-4">
                            <label class="small mb-1 mr-1">Pangkat Tujuan</label>
                            <input class="form-control"  type="text" value="{{ $item->Pangkat->nama_pangkat }}, {{ $item->Pangkat->golongan }}" readonly></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
