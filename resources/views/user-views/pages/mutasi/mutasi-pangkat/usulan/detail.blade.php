                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <a href="{{ route('usulan-pangkat.index') }}" class="btn btn-primary px-4" >Kembali</a>
                                    </div>
                            </form>
                        </div>
                    </div>
