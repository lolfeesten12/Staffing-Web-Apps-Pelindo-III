                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form action="{{ route('usulan-pangkat.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select" name="id_pegawai" id="id_pegawai"
                                            ...
                                            <option value="{{ $item->id_pegawai }}">{{ $item->nama_pegawai }}, {{ $item->Pangkat->nama_pangkat }}, {{ $item->Pangkat->golongan }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select" name="id_pangkat_tujuan" id="id_pangkat_tujuan"
                                            ...
                                            @foreach ($pangkat as $tes)
                                            <option value="{{ $tes->id_pangkat }}">{{ $tes->nama_pangkat }}, {{ $tes->golongan }}
                                            </option>
                                            @endforeach
                                        </select>
