                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form action="{{ route('usulan-jabatan.update', $item->id_usulan) }}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row g-3">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select" name="id_pegawai" id="id_pegawai"
                                            ...
                                            <option value="{{ $item->Pegawai->id_pegawai }}">{{ $item->Pegawai->nama_pegawai }}, {{ $item->Pegawai->Jabatan->nama_jabatan }}</option>
                                            @foreach ($pegawai as $tes)
                                            <option value="{{ $tes->id_pegawai }}">{{ $tes->nama_pegawai }}, {{ $tes->Jabatan->nama_jabatan }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select" name="id_jabatan_tujuan" id="id_jabatan_tujuan"
                                            ...
                                            <option value="{{ $item->Jabatan->id_jabatan_tujuan }}">{{ $item->Jabatan->nama_jabatan }}</option>
                                            @foreach ($jabatan as $tess)
                                            <option value="{{ $tess->id_jabatan }}">{{ $tess->nama_jabatan }}
                                            </option>
                                            @endforeach
                                        </select>
