    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Proses SK Mutasi {{ $item->jenis_mutasi }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('mutasi.update', $item->id_usulan) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <label class="small mt-3">Detail Mutasi Pegawai</label>
                    <hr>
                    </hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label class="small mb-1 mr-1">Resign</label>
                            <input class="form-control"  type="text" value="{{ "Mutasi Resign" }}" readonly></input>
                        </div>
