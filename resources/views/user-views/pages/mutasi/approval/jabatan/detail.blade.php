                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        <label class="form-label mr-1">Jabatan Tujuan</label><span class="mr-4 mb-3"
                                    ...
                                    <div class="col-12">
                                        <a href="{{ route('approval-mutasi-jabatan.index') }}" class="btn btn-primary px-4" >Kembali</a>
                                    </div>
                            </form>
                        </div>
                    </div>
