...
<main class="page-content">
    <div class="container-fluid">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Approval Mutasi</div>
            <div class="ps-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('approval-mutasi.show',$item->id_usulan) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Detail Data Usulan"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light-success text-success">
                <h5 class="modal-title" id="exampleModalCenterTitle">Konfirmasi Setujui Data Usulan Mutasi</h5>
            ...
            <form action="{{ route('status-approval-mutasi', $item->id_usulan) }}?status_approval=Terima" method="POST" class="d-inline">
                ...
                <div class="modal-body">
                    <div class="form-group">Apakah Anda Yakin Menyetujui Mutasi Pegawai {{ $item->Pegawai->nama_pegawai }}, dengan nomor surat {{ $item->nomor_surat }}?</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light-danger text-danger">
                <h5 class="modal-title" id="exampleModalCenterTitle">Konfirmasi Tolak Data Usulan Mutasi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('status-approval-mutasi', $item->id_usulan) }}?status_approval=Tolak" method="POST" class="d-inline">
                @csrf
                <div class="modal-body">
                    <div class="form-group">Apakah Anda Yakin Menolak Mutasi Pegawai {{ $item->Pegawai->nama_pegawai }}, dengan nomor surat {{ $item->nomor_surat }}?</div>
                    <div class="col-12 mt-2">
                        <label class="small mb-1" for="keterangan_approval">Keterangan Approval</label>
                        <textarea class="form-control" id="text" type="keterangan_approval" name="keterangan_approval"
                            value="{{ old('keterangan_approval') }}"></textarea>
