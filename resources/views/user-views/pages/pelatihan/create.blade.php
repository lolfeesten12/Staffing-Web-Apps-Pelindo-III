                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form action="{{ route('program-pelatihan.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-6">
                                    ...
                                    <div class="col-3">
                                        <label class="form-label mr-1" for="jenis_pelatihan">Jenis Pelatihan</label><span
                                            ...
                                            <option value="{{ old('jenis_pelatihan')}}"> Pilih Jenis Pelatihan</option>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="status_wajib" id="status_wajib" class="form-select"
                                            ...
                                            <option value="{{ old('status_wajib')}}"> Pilih Status Wajib</option>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input class="form-control" id="periode_awal" type="date" name="periode_awal"
                                            placeholder="Input Periode Mulai Pelatihan" value="{{ old('periode_awal') }}"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input class="form-control" id="periode_akhir" type="date" name="periode_akhir"
                                            placeholder="Input Periode Selesai Pelatihan" value="{{ old('periode_akhir') }}"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input class="form-control" id="biaya" type="number" name="biaya"
                                            placeholder="Input Biaya Pelatihan" value="{{ old('biaya') }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="keterangan" type="text" name="keterangan" cols="5"
                                            placeholder="Input Keterangan Pelatihan" value="{{ old('keterangan') }}"
