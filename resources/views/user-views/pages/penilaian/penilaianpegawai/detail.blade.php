                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">: {{ $nilai->Pegawai->nama_pegawai }}</div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <label class="col-sm-3 ">Jabatan</label>
                                        <div class="col-sm-9">: {{ $nilai->Pegawai->Jabatan->nama_jabatan }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">: {{ $nilai->Pegawai->UnitKerja->unit_kerja }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
