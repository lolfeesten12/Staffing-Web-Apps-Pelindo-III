                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form action="{{ route('penilaian-pegawai.store') }}" method="POST" id="form1"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input class="form-control" id="nilai_komitmen" type="number" name="nilai_komitmen"
                                        placeholder="Input Nilai Komitmen" value="{{ old('nilai_komitmen') }}" min="1" max="100"
                                ...
                                <div class="col-3">
                                    ...
                                    <input class="form-control" id="nilai_disiplin" type="number" name="nilai_disiplin"
                                        placeholder="Input Nilai Disiplin" value="{{ old('nilai_disiplin') }}" min="1" max="100"
                                ...
                                <div class="col-3">
                                    ...
                                    <input class="form-control" id="nilai_sikap" type="number" name="nilai_sikap"
                                        placeholder="Input Nilai Prakarsa" value="{{ old('nilai_sikap') }}" min="1" max="100"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="catatan_penilaian" type="text" name="catatan_penilaian"
                                        placeholder="input Catatan Penilaian untuk Pegawai" value="{{ old('catatan_penilaian') }}"
