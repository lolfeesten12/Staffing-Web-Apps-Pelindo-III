                                ...
                                <table id="example" class="table table-striped table-bordered dataTable"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 70px;">Nilai SKP</th>
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 70px;">Nilai PPK</th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $item->nilai_prestasi_kerja }}</td>
                                            <td>{{ $item->status_acc }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('penilaian-pegawai.show',$item->id_penilaian) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Detail Data Pegawai"
                                                    class="btn btn-sm btn-secondary"><i class="lni lni-eye"></i></a>
                                                <a href="{{ route('penilaian-pegawai.edit',$item->id_penilaian) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit Data Pegawai"
        ...
        <div class="modal-content bg-danger">
            ...
            <form action="{{ route('penilaian-pegawai.destroy', $item->id_penilaian) }}" method="POST" class="d-inline">
                ...
                <div class="modal-body text-white">
                    Apakah Anda Yakin Menghapus Data Penilaian dengan nomor {{ $item->no_penilaian }} atas nama {{ $item->Pegawai->nama_pegawai }} ?</div>
